...
//        ForumMessageStreamObserver forumMessageStreamObserver = new ForumMessageStreamObserver(downloadLocation, id);
        SubscribeUnSubscribe sub = SubscribeUnSubscribe.newBuilder().setUsrName("joao").setTopicName("topic01").build();
        ForumMessageStreamObserver forumMessageStreamObserver = new ForumMessageStreamObserver("/home/jpmatos/Downloads/", "obs1");
